    ...
    return(
        <div className="card">
            ...
            <div className="cardbody">
                ...
                <button className="probtn" onClick={()=>setpopbtn(true)}>View Details</button>
            </div>
            <Popup trigger={popbtn} setTrigger ={setpopbtn} img={props.img} category={props.category} title={props.title} description={props.description} price={props.price} />
        </div>
    )
